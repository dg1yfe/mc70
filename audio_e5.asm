...
;5
               ...
               DITHER               ;+14 14
               BFILT2               ;+14 28
               ldab #0              ;+2  30    ; remove DC offset
               sba                  ;+1  31    ; invert amplitude (in every 2nd sample) to invert noise spectrum
               SAMPBUF(5)           ;+21 52
                                    ;------
                                    ;   394
;6
